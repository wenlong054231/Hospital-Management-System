    ...
    <header class="text-black">
      ...
      <form action="addcontent.php" method="post">
        ...
        <div class="col-md-12 form-group">
          ...
          <input type="text" placeholder="Enter Author's Name" class="form-control" id="author" name="author" required="required">
            </div>
            <div class="col-md-12 form-group">
            ...
            <div class="col-md-12 form-group">
              ...
              <input type="text" placeholder="Enter Content" class="form-control" id="content" name="content" required="required">
            </div>
          </div>
          <div class="row">

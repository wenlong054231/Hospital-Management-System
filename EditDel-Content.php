...
<head>
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <br>
    <div class="container">
    <button type="button" class="btn btn-primary float-right" onclick="window.location.href='Manage-Content.php'">Back</button>
    </div>
    ...
    <h2 class="text-left">Search</h2>
      <p class="text-left">Type something in the input field to search the table for Content IDs, Author Names, Contents or Dates:</p>
                ...
                <tbody id="myTable">
                  <?php
                                  if(mysqli_num_rows($result) > 0)
                                  {
                                       ...
                                       ?>
                  <tr>
                    <th scope="row"><?php echo $row['ContentUID']; ?></th>
                    ...
                    <td>
                      ...
                      <button type="submit" name="edit_btn" class="btn btn-success">Edit</button>
				              ...
				              <form action="delcontent.php" method="post">
					            <input type="hidden" name="del_id" value="<?php echo $row['ContentUID']; ?>">

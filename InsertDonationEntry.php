  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <header class="text-black">
      <div class="container text-center p-2 my-5">
        <h2>Insert Donation Entry</h2>
      </div>
    </header>


      <form action="insert-donation.php" method="post">
        <div class= "container">
        <div class="row">
        <div class="col-md-12 form-group">
          <label for="hosname">Hospital Name</label>
          <input type="text" placeholder="Enter Hospital Name" class="form-control" name="hosname" required="required">
            </div>
            <div class="col-md-12 form-group">
            ...
            <div class="col-md-12 form-group">
              ...
              <input type="text" placeholder="Enter Hospital Description" class="form-control" name="description" required="required">
            </div>
          </div>
          <div class="row">

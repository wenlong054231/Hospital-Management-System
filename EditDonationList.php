...
if(isset($_POST['edit_btn']))
{
  ...
  $query = "SELECT * FROM donationentry WHERE DonationEntryUID = '$HospitalUID'";
...
<head>
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <header class="text-black">
      ...
      <form action="editdonation.php" method="post">
        <input type="hidden" name ="edit_id" value="<?php echo $row['DonationEntryUID']?>">
        <div class= "container">
        <div class="row">
        <div class="col-md-12 form-group">
          <label for="h_name">Hospital Name</label>
          <input type="text" class="form-control" value="<?php echo $row['HospitalName']?>" name="h_name" required="required">
            </div>
            <div class="col-md-12 form-group">
            ...
            <div class="col-md-12 form-group">
              ...
              <input type="text" class="form-control" value="<?php echo $row['Description']?>" name="desc" required="required">
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm form-group">
              <button class="btn btn-primary btn-lg btn-block" name="cancel" onclick="window.location.href='Manage-Donation.php'">Cancel</button>
            </div>
          </div>
        </div>
      </form>

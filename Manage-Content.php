    ...
    <div class="container p-5 my-5">
      <div class="row">
        <div class="col-md-6 mx-auto text-center">
          ...
          <br><br>
          <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='Add-Content.php'">Add Content</button>
        </div>

        <div class="col-md-6 mx-auto text-center">
          <img src= "Image/edit.png" width="100" height="100" class= "img-responsive">
          <br><br>
          <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='EditDel-Content.php'">Edit / Delete Content</button>
        </div>
      </div>
    </div>
  </body>

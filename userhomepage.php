...
<header class="u-clearfix u-header u-palette-1-base u-header" id="sec-7dc9"><div class="u-clearfix u-sheet u-sheet-1">
        <nav style="width: 1325px; margin-left: 180px; padding-top: 20px;">
          <div class="u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1">
				<li class="u-nav-item"><a class="u-radius-6 u-text-hover-white u-border-2 u-border-hover-white u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="userhomepage.php" style="padding: 10px 20px;">Home</a></li>
  ...
  <div>
  <a href="logout.php"><button type="button" class="btn btn-primary float-right" style="margin-right: 20px; margin-left: 10px;">Logout</button></a>
